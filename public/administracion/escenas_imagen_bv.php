...
// Create page object
$escenas_imagen_blobview = new cescenas_imagen_blobview();
$Page =& $escenas_imagen_blobview;

// Page init
$escenas_imagen_blobview->Page_Init();

// Page main
$escenas_imagen_blobview->Page_Main();
?>
<?php
$escenas_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cescenas_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'escenas_imagen_blobview';
	...
	//
	function cescenas_imagen_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('escenas', 'x_imagen');
