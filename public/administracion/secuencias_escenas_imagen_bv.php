...
// Create page object
$secuencias_escenas_imagen_blobview = new csecuencias_escenas_imagen_blobview();
$Page =& $secuencias_escenas_imagen_blobview;

// Page init
$secuencias_escenas_imagen_blobview->Page_Init();

// Page main
$secuencias_escenas_imagen_blobview->Page_Main();
?>
<?php
$secuencias_escenas_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class csecuencias_escenas_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'secuencias_escenas_imagen_blobview';
	...
	//
	function csecuencias_escenas_imagen_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('secuencias_escenas', 'x_imagen');
