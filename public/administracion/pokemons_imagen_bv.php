...
// Create page object
$pokemons_imagen_blobview = new cpokemons_imagen_blobview();
$Page =& $pokemons_imagen_blobview;

// Page init
$pokemons_imagen_blobview->Page_Init();

// Page main
$pokemons_imagen_blobview->Page_Main();
?>
<?php
$pokemons_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cpokemons_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'pokemons_imagen_blobview';
	...
	//
	function cpokemons_imagen_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('pokemons', 'x_imagen');
