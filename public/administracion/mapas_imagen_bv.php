...
// Create page object
$mapas_imagen_blobview = new cmapas_imagen_blobview();
$Page =& $mapas_imagen_blobview;

// Page init
$mapas_imagen_blobview->Page_Init();

// Page main
$mapas_imagen_blobview->Page_Main();
?>
<?php
$mapas_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cmapas_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'mapas_imagen_blobview';
	...
	//
	function cmapas_imagen_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('mapas', 'x_imagen');
