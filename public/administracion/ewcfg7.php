...
define("EW_PROJECT_NAME", "pokemon", TRUE); // Project name
define("EW_RANDOM_KEY", '9kmv5rQM03KJOvrk', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "pokemon.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", "pokemon", TRUE);
...
define("EW_ADMIN_PASSWORD", "asdasd123", TRUE); // Administrator password
